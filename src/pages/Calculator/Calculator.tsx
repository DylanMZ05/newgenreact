...
const Calculator: React.FC = () => {
  ...
  return (
    <section className="min-h-screen bg-[url('/assets/images/Products/Patios&Pergolas/Attached/20.webp')] bg-cover bg-center flex flex-col items-center justify-center">
      <BlockSection />
      <div className="w-full min-h-[calc(100vh-80px)] bg-black/50 flex flex-col lg:flex-row items-center justify-center gap-5 px-3 md:px-[50px] py-10 md:py-[100px]">
